                            ...
                            <table id="ex" class="table table-bordered table-hover mt-2">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $item->name_brands }}</td>
                                            <td>{{ $item->brands_slug }}</td>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Action buttons">
                                                    <a href="{{ route('brand-item.edit', ['brand_item' => $item->id_brands]) }}"
                                                        class="btn btn-sm btn-warning"><i
                                                            class="nav-icon fas fa-edit"></i></a>
                                                    <button class="btn btn-sm btn-danger btn-delete"
                                                        data-action="{{ route('brand-item.destroy', ['brand_item' => $item->id_brands]) }}">
